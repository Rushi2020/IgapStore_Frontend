...
const routes: Routes = [
  ...
  {path:"admin-sliders",component:AndminslidersComponent},
  {path:"admin-slider/:id",component:AndminsliderComponent},
...
export const RoutingComponent = [HomeComponent , AdminloginComponent , AdminhomeComponent ,
    AdminproductcategoriesComponent, AdminproductcategoryComponent , LogoutComponent , AndminslidersComponent ,
     AndminsliderComponent, AdmintestimonialsComponent, AdmintestimonialComponent
  ];
