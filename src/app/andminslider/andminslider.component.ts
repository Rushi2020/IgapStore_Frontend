...
@Component({
  selector: 'app-andminslider',
  templateUrl: './andminslider.component.html',
  styleUrls: ['./andminslider.component.css']
})
export class AndminsliderComponent implements OnInit {
